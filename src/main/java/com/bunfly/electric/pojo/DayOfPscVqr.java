...
public class DayOfPscVqr {
    ...
    public DayOfPscVqr(String pscNo, String date, String upperTime, String lowTime, String vqr, String score) {
	...
	public String toString() {
		return "DayOfPscVqr [pscNo=" + pscNo + ", date=" + date + ", upperTime=" + upperTime + ", lowTime=" + lowTime
				+ ", vqr=" + vqr + ", score=" + score + "]";
	}
